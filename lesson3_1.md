...
> Line 223-224 А теперь мы переходим в основную ветку, и внесем ПЕРВЫЙ дополнительный текст для конфликта наложения изменений при слиянии веток, который будем рихтовать вручную, и закоммитим его, чтобы развести ветки. А здесь всё правильно.
Вот так уот.
